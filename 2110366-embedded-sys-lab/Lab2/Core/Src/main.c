...
//	  Problem 3
//	  if (HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13) == GPIO_PIN_SET && pressed)
//	  {
//		  HAL_Delay(100);
...
//	  Problem 5
	  char c[5];
	  if(HAL_UART_Receive(&huart2, c+4, 1, 1000) == HAL_OK) {
		  HAL_UART_Transmit(&huart2, c+4, 1, 1000);

		  c[0] = c[1];
		  c[1] = c[2];
		  c[2] = c[3];
		  c[3] = c[4];
		  if(c[1] == 'o' && c[2] == 'n' && c[3] == 13){
			  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, GPIO_PIN_SET);
		  }
		  if(c[0] == 'o' && c[1] == 'f' && c[2] == 'f' && c[3] == 13){
