...
with DAG('dsde_python',  start_date=pendulum.today('UTC').add(days=-1), schedule=datetime.timedelta(days=1)) as dag:
    ...
    inform = PythonOperator(task_id='inform_status', python_callable=show_status, op_args=[
                            ping.output, ping2.output])
